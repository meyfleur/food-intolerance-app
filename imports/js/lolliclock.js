...
(function () {
  ...
  function LolliClock(element, options) {
    ...
    if (!options.autoclose) {
      ...
      $('<div class="lolliclock-button waves-effect red btn left"><i class="ion-close-round"></i></div>')
        .click($.proxy(this.hide, this))
        .appendTo($closeButtons);
      $('<div class="lolliclock-button waves-effect waves-green btn right"><i class="ion-checkmark-round"></i></div>')
